<?php
namespace Ecompassaro\Conta\Registro;
...
class ViewModel extends ContaViewModel
{
     ...
     * @param mixed $params
     */
    public function __construct(Acesso $acesso, AuthenticationService $authentication, AutenticacaoManager $autenticacaoManager, Form $form, $params = array())
    {
